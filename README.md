...
В таблице приведены три варианта hyper‑prior для кодирования steering‑вектора и их основные показатели:

Гауссов prior требует минимум метаданных (192 бит) и даёт самый низкий общий объём (690 396 бит), но имеет относительно высокую MSE (5.1 × 10⁻⁴).
Эмпирический prior использует больше метаданных (8 320 бит) и даёт наибольший объём (804 596 бит) с наибольшей MSE (4.49 × 10⁻³), то есть самое неэффективное сочетание.
Lloyd–Max prior — компромисс: метаданные (16 480 бит) занимают вдвое больше, чем у гауссова, итоговый объём (803 685 бит) практически равен эмпирическому, но MSE рекордно малая (4.07 × 10⁻⁵), что обеспечивает более точное восстановление.
...
<img src="[https://github.com/jon/coolproject/raw/master/image/image.png](https://github.com/julmaty/LLM-compressor/blob/main/Diagramm.png)"
